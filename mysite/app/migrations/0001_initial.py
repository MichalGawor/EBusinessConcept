# Generated by Django 2.0.6 on 2018-06-08 10:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Alcohol',
            fields=[
                ('AlchoholID', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DateFrom', models.DateField(default=datetime.datetime.now)),
                ('DateTo', models.DateField(default=datetime.datetime.now)),
                ...
                ('AlcoholID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Alcohol')),
            ],
        ),
        migrations.CreateModel(
            name='Shop',
        ...
        migrations.AddField(
            model_name='alcohol',
            name='TypeID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.AlcoholType'),
        ),
    ]
